/* Write a program that asks the user to enter the month (letting the user enter an inte-
ger in the range of 1 through 12) and the year. The program should then display the
